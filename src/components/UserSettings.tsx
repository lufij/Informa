      ...
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto bg-gradient-to-br from-yellow-50 via-pink-50 to-purple-50">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="info" className="space-y-6">
            <div className="bg-white/60 backdrop-blur-sm rounded-lg p-6 space-y-4 border-2 border-purple-200 shadow-md">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-12 h-12 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-full flex items-center justify-center">
                  <Heart className="w-6 h-6 text-white" />
                </div>
                <div>
                  <h3 className="flex items-center gap-2">Cuéntanos sobre ti</h3>
                  <p className="text-sm text-gray-600">Personaliza tu perfil de la comunidad</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                {/* Location */}
                <div className="space-y-2">
                  <Label htmlFor="location" className="flex items-center gap-2 text-pink-700">
                  ...
                  <Input
                    ...
                    maxLength={50}
                    className="border-pink-200 focus:border-pink-400 bg-white"
                  />
                ...
                {/* Interests */}
                <div className="space-y-2">
                  <Label htmlFor="interests" className="flex items-center gap-2 text-orange-700">
              ...
              <Button
                ...
                className="w-full bg-gradient-to-r from-yellow-400 via-pink-500 to-purple-600 text-white hover:from-yellow-500 hover:via-pink-600 hover:to-purple-700 shadow-lg"
              >
                {isSavingProfile ? (
                  <>
                    <RefreshCw className="w-4 h-4 mr-2 animate-spin" />
              ...
              <div className="bg-gradient-to-r from-yellow-100 via-pink-100 to-purple-100 border-2 border-purple-300 rounded-lg p-4">
                <p className="text-sm text-center text-gray-700 flex items-center justify-center gap-2">
                  <Sparkles className="w-4 h-4 text-pink-500" />
                  <span>Esta información será visible en tu perfil público</span>
                </p>
              </div>

              {/* Firefighter Role Activation */}
              {userProfile.role !== 'firefighter' && (
                <div className="bg-gradient-to-br from-red-50 to-orange-50 border-4 border-red-500 rounded-lg p-6 space-y-4 mt-6">
                  <div className="flex items-center gap-3 mb-2">
                    <div className="w-12 h-12 bg-gradient-to-br from-red-600 to-orange-600 rounded-full flex items-center justify-center animate-pulse">
                      <span className="text-2xl">🚒</span>
                    </div>
                    <div>
                      <h3 className="flex items-center gap-2 text-red-700">
                        Perfil de Bombero Voluntario
                      </h3>
                      <p className="text-sm text-gray-700">
                        Herramientas especiales para emergencias
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white/80 rounded-lg p-4 space-y-2">
                    <p className="text-sm text-gray-700">
                      <span className="font-semibold text-red-700">¿Eres bombero voluntario?</span> Activa tu perfil especial para acceder a:
                    </p>
                    <ul className="text-sm text-gray-700 space-y-1 ml-4">
                      <li className="flex items-center gap-2">
                        <span className="text-red-600">•</span>
                        <span>Botón flotante de emergencia 🚨</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <span className="text-red-600">•</span>
                        <span>Publicación por voz con reconocimiento de texto</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <span className="text-red-600">•</span>
                        <span>Alertas destacadas en el feed comunitario</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <span className="text-red-600">•</span>
                        <span>Edición de emergencias con fotos adicionales</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <span className="text-red-600">•</span>
                        <span>Badge especial: 🚒 Bombero Voluntario</span>
                      </li>
                    </ul>
                  </div>

                  <Button
                    onClick={handleChangeToFirefighter}
                    disabled={isChangingRole}
                    className="w-full bg-gradient-to-r from-red-600 to-orange-600 text-white hover:from-red-700 hover:to-orange-700 shadow-lg h-12"
                  >
                    {isChangingRole ? (
                      <>
                      ...
                      <>
                        ...
                        Activar Perfil de Bombero Voluntario
                      </>
                    )}
                  </Button>
                  ...
                  <div className="bg-yellow-100 border-2 border-yellow-400 rounded-lg p-3">
                    <p className="text-xs text-center text-yellow-800 flex items-center justify-center gap-2">
                      ...
                      <span>Este perfil es para bomberos voluntarios de Gualán, Zacapa</span>
                    </p>
                  </div>
                </div>
              )}
